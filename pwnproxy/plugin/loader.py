...
from pwnproxy.plugin.base import Finding, HookPlugin, PwnPlugin, ScannerPlugin
from pwnproxy.plugin.config import load_config
from pwnproxy.plugin.discovery import discover_installed
from pwnproxy.plugin.watchdog import PluginWatchdog
...
class PluginLoader:
    ...
    async def load_from_package(self, package_name: str) -> Optional[str]:
        from pwnproxy.plugin.discovery import install_package
