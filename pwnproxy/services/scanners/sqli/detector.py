...
from pwnproxy.services.scanners.sqli.models import ScanFinding
from pwnproxy.services.scan.params import InjectionPoint
from pwnproxy.services.scanners.sqli.payloads import Payload
...
class TimeBasedDetector:
    ...
    def _get_primary_payloads(self) -> list[Payload]:
        from pwnproxy.services.scanners.sqli.payloads import TIME_PAYLOADS
        seen = set()
        uniq = []
