...
from pwnproxy.plugins.core.base import Finding, HookPlugin, PwnPlugin, ScannerPlugin
from pwnproxy.plugins.core.config import load_config
from pwnproxy.plugins.core.discovery import discover_installed
from pwnproxy.plugins.core.watchdog import PluginWatchdog
...
class PluginLoader:
    ...
    async def load_from_package(self, package_name: str) -> Optional[str]:
        from pwnproxy.plugins.core.discovery import install_package
