...
from pwnproxy.scanners.sqli.models import ScanFinding
from pwnproxy.scanners.common.params import InjectionPoint
from pwnproxy.scanners.sqli.payloads import Payload
...
class TimeBasedDetector:
    ...
    def _get_primary_payloads(self) -> list[Payload]:
        from pwnproxy.scanners.sqli.payloads import TIME_PAYLOADS
        seen = set()
        uniq = []
